...
#import "MultitaskBackgroundView.h"
...
- (MultitaskBackgroundView*)mj_popupBackgroundView {
    return objc_getAssociatedObject(self, kMJPopupBackgroundView);
}

- (void)setMj_popupBackgroundView:(MultitaskBackgroundView *)mj_popupBackgroundView {
...
- (void)presentPopupView:(UIView*)popupView animationType:(MJPopupViewAnimation)animationType
{
    ...
    // BackgroundView
    self.mj_popupBackgroundView = [[MultitaskBackgroundView alloc] initWithFrame:sourceView.bounds];
