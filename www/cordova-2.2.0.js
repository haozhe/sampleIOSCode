...
//alert("cordova js file loaded");

//code Stan added for integrating Cordova
var cordovaReady = false;

document.addEventListener("deviceready", onDeviceReady, false);
console.log("cordova device ready bound a newer one 2");

function onDeviceReady(){
	console.log("cordova ready in device");
	cordovaReady = true;
}
