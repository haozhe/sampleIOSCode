...
//Stan modified to include EGO pull down refresh code
#import "EGORefreshHeaderView.h"

@class CDVCommandQueue;
@class CDVCommandDelegateImpl;

@interface CDVViewController : UIViewController <UIWebViewDelegate, EGORefreshHeaderDelegate, UIScrollViewDelegate>{
    
    EGORefreshHeaderView *_refreshHeaderView;
    
//    IBOutlet UIWebView *webView;
    
//    IBoutlet CDVCordovaView* webView;
